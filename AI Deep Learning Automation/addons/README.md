...
**Install:** copy both into `Documents\NinjaTrader 8\bin\Custom\AddOns\` and compile with the strategies (see [../SETUP.md](../SETUP.md)). Redacted the same way as the rest of the repo.
